...
| `/claude-office:aggregate` | Daily (or on-demand) | Parses all `team/*/activity/**/*.md` logs + `projects/*/meetings/**/*.md` + git diffs, writes per-person Team Notes and meeting decisions/commitments into each project's `status.md` |
...
/claude-office:aggregate (daily, scheduled)
  reads:  team/*/activity/**/*.md logs (what was done)
